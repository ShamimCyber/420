...
os.system('xdg-open https://github.com/SF-61551470458263 ')
...
logo = ("""
   ...
   _____ __  _____    __  _________  ___
  / ___// / / /   |  /  |/  /  _/  |/  /
  \__ \/ /_/ / /| | / /|_/ // // /|_/ / 
 ___/ / __  / ___ |/ /  / // // /  / /  
...
\033[1;94m       [+]        CREATED BY   :  SHAMIM               \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  SHAMIM CYBER               \033[1;94m[+]

\033[1;94m       [+]        TEAM              :  HELLO HECKER 0.2        \033[1;94m[+]
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://facebook.com/groups/61551470458263/')
        ...
        if Alif in ["2","02"]:
            ...
            os.system('xdg-open https://www.facebook.com/61551470458263')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSHAMIM-X\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[SHAMIM-X-OK💉] {uid} | {ps}")
                ...
                print(f"\x1b[38;5;196m[SHAMIM-X-CP🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[SHAMIM-X👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
